      ...
      <footer className="footer">
        <div className="container footer-grid">
          ...
          <div>
            ...
            <p className="footer-link">📞 01710-001100</p>
            <p className="footer-link">📍 Tangail, Dhaka, Bangladesh</p>
            <div className="social-row">
              ...
              <a href="https://wa.me/8801710001100" target="_blank" rel="noreferrer" className="social-btn" title="WhatsApp">
